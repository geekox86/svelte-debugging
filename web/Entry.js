...
function create_fragment(ctx) {
	let div;
	let t_value = /*x*/ ctx[0][/*x*/ ctx[0].length - 1] + "";
	let t;
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*x*/ 1 && t_value !== (t_value = /*x*/ ctx[0][/*x*/ ctx[0].length - 1] + "")) set_data_dev(t, t_value);
		},
		i: noop,
		o: noop,
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ produce: an, x });
